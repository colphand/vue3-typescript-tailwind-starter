      ...
      <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
        <div class="relative col-span-2 lg:col-start-1 lg:row-start-2">
          ...
          <blockquote class="text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>“The entire platform is very intuitive to use and works seamlessly with Outlook. Combine that with terrific customer service, and it’s a real winner.”</p>
          </blockquote>
        </div>
        <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
          <img class="rounded-xl bg-indigo-50 lg:rounded-3xl" src="https://source.unsplash.com/random/?face,person" alt="" />
        </div>
        <figcaption class="text-base lg:col-start-1 lg:row-start-3">
          <div class="font-semibold text-gray-900">Torin Roher</div>
          <div class="mt-1 text-gray-500">Corporate Communications Specialist, NAES</div>
        </figcaption>
      </figure>
    </div>
  </section>
